...
#playing on Jean M's LCD screen 1024 x 768
#this file needs to be placed in the default PI folder
...
/bin/sleep 3
sudo -u pi chromium-browser --kiosk --incognito /home/pi/oracle2/index.html &
# End of script
...
#added back in @escreensaver and set to fadeplot per Jean Margarete
